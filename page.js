function play(choice) {
    ...
    setTimeout(() => {
      if (oChoice === 1 && pChoice === "rock") {
        document.getElementById('o-img').src = "rock.svg";
        ...
        document.getElementById('o-img').src = "paper.svg";
        ...
        document.getElementById('o-img').src = "scissors.svg";
  ...
  function reset() {
    ...
    document.getElementById('ties').innerHTML = sessionStorage.getItem("tieCount");
    document.getElementById('losses').innerHTML = sessionStorage.getItem("lossCount");
    document.getElementById('o-img').src = "mystery.svg";
